...
const EN = {
  ...
  'launch.lastMissingProfile': 'the account "{name}" is gone; using "{fallback}" instead',
  'launch.stripped': '{name} was set in your environment. {impact}, so cam removed it from this session only.',
  'launch.kept': '{name} is set in your environment. {impact}, and cam is not removing it — this session may not be the account named above.',
  ...
  'which.ambientPassed': '{name} is set — cam does NOT remove it here, and it overrides the account above',
  ...
  'which.reason.first': 'the first account on the list',
  ...
  'doctor.isolationUnreadableHint': 'the probe may have timed out, or this Claude Code version changed its output — try: cam doctor --deep',
  ...
  'shell.conflictFile': 'left untouched — a claude function you wrote yourself',
  ...
  'rm.refuseDefaultHint': 'remove one of the accounts you added with cam add; run: cam ls',
  ...
  'exec.notFound': 'can’t find the command "{cmd}"',
  ...
  'err.claudeBinPinned': 'The claude you pinned could not be used: {path}',
...
const PT = {
  ...
  'launch.lastMissingProfile': 'a conta "{name}" sumiu; usando "{fallback}" no lugar',
  'launch.stripped': '{name} estava no seu ambiente. {impact}, então o cam removeu só nesta sessão.',
  'launch.kept': '{name} está definida no seu ambiente. {impact}, e o cam não vai remover — esta sessão pode não ser a conta indicada acima.',
  ...
  'which.ambientPassed': '{name} está definida — o cam NÃO remove aqui, e ela sobrepõe a conta acima',
  ...
  'which.reason.first': 'a primeira conta da lista',
  ...
  'doctor.isolationUnreadableHint': 'o teste pode ter estourado o tempo, ou esta versão do Claude Code mudou a saída — tente: cam doctor --deep',
  ...
  'shell.conflictFile': 'mantido intacto — uma função claude escrita por você',
  ...
  'rm.refuseDefaultHint': 'remova uma das contas que você criou com cam add; rode: cam ls',
  ...
  'exec.notFound': 'não encontrei o comando "{cmd}"',
  ...
  'err.claudeBinPinned': 'Não foi possível usar o claude que você fixou: {path}',
